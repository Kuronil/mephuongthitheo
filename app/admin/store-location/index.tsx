...
export default function AdminStoreLocationPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'edit' | 'map'>('overview')
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'edit' && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Chỉnh sửa thông tin cửa hàng</h3>
            <p className="text-gray-600 mb-6">
              Truy cập trang chỉnh sửa để cập nhật thông tin cửa hàng
            </p>
            <Button
