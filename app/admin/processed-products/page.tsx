...
function AdminProcessedProductsContent() {
  ...
  const fetchProducts = async (page = 1) => {
    try {
      ...
      const params = new URLSearchParams({
        ...
        limit: "12",
        search: searchTerm,
        category: "Thịt chế biến", // Lọc chỉ sản phẩm chế biến
        sortBy,
        sortOrder,
  ...
  }, [searchTerm, sortBy, sortOrder, showInactive])
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Quản lý sản phẩm chế biến</h1>
              <p className="text-gray-600 mt-2">Quản lý danh sách sản phẩm thịt chế biến</p>
            </div>
            <Link
              href="/admin/products/new?category=Thịt chế biến"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="lg:col-span-2">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Tìm kiếm sản phẩm chế biến..."
                  value={searchTerm}
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-600 mb-2">Chưa có sản phẩm chế biến</h3>
              <p className="text-gray-500 mb-4">Bắt đầu bằng cách thêm sản phẩm chế biến đầu tiên</p>
              <Link
                href="/admin/products/new?category=Thịt chế biến"
...
export default function AdminProcessedProductsPage() {
  return (
    <AdminLayout>
      <AdminProcessedProductsContent />
    </AdminLayout>
  )
}
