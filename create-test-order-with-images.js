/**
 * Script tạo đơn hàng test với hình ảnh sản phẩm
 * Chạy lệnh: node create-test-order-with-images.js
 */
...
// Thông tin đơn hàng test với hình ảnh
const testOrderData = {
  items: [
    {
      id: 1,
  ...
  total: 437000, // (159000*1) + (59000*2) + (159000*1)
...
async function createTestOrder() {
  console.log('╔═══════════════════════════════════════════╗');
  console.log('║   TẠO ĐƠN HÀNG TEST VỚI HÌNH ẢNH         ║');
  console.log('╚═══════════════════════════════════════════╝');
  console.log('');
